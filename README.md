...
3. In the MobileFirst console, under **Applications** → **PinCodeWin10** → **Security** → **Map scope elements to security checks.**, add a mapping from `accessRestricted` to `PinCodeAttempts`.
